...
text_file = open("dictionary.txt", "a")
...
def get_2_word():
    count = 0               # count diente hier als Überprüfung, ob wirklich alle Wörter der Website übernommen wurden
    for i in rows2:
        word = i.text.split()
        string = str(word)
        text_file.write(string)
        text_file.write("\n")
        # wir mussten hier mit Slicing arbeiten, weil ansonsten noch folgende Zeichen: "['']" in den Wörten enthalten wären
        # somit haben wir hier wirklich nur die reinen Wörter verwendet
        # und da das Wort am Anfang des Satzes großgeschrieben wird, haben wir jedes Wort nochmal in Großschreibung zum Dictionary hinzugefügt
